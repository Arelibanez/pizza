    ...
    <div className="bg-white shadow-lg rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300 flex flex-col justify-between">
      <div>
        ...
        <div className="p-6">
          ...
          <p className="text-gray-600 text-sm mb-3">{ingredients}</p>
        </div>
      </div>
...
const App: React.FC = () => {
  ...
  return (
    <div className="font-serif flex flex-col min-h-screen"> {/* MODIFIED: Removed mx-auto max-w-screen-xl, added flex flex-col min-h-screen */}
      {/* Navbar */}
      <nav className="bg-red-700 shadow-lg sticky top-0 z-50 w-full"> {/* ADDED: w-full */}
        <div className="container mx-auto px-6 py-3 flex justify-between items-center">
          <a href="#" className="text-3xl font-bold text-white">Pizzeria Astrale</a>
          <div className="hidden md:flex space-x-4 items-center"> {/* Added items-center */}
            ...
            {/* Cart Icon/Button */}
            <button onClick={openCartModal} className="relative text-amber-400 hover:text-amber-300 transition-colors p-2"> {/* MODIFIED: text-white to text-amber-400 */}
          ...
          <div className="md:hidden flex items-center"> {/* Added flex items-center */}
            ...
            <button onClick={openCartModal} className="relative text-amber-400 hover:text-amber-300 transition-colors p-2 mr-2"> {/* MODIFIED: text-white to text-amber-400 */}
      ...
      >
        <div className="text-center p-4" style={{ textShadow: '0 0 5px rgba(0,0,0,0.7)' }}> 
          <h1 className="text-6xl font-bold mb-4">Benvenuti alla Pizzeria Astrale</h1> {/* MODIFIED: Added Benvenuti alla */}
      ...
      <main className="flex-grow w-full"> {/* ADDED: flex-grow w-full */}
        ...
        <section id="contatti" className="py-20 bg-red-700 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            {/* Google Maps Embed */}
            <div className="mt-6 mb-8 flex justify-center"> {/* MODIFIED: Added flex justify-center */}
              <iframe
                src="https://maps.google.com/maps?q=Milano%20Via%20Plinio%206&t=&z=15&ie=UTF8&iwloc=&output=embed"
                width="80%" // MODIFIED: Changed from 100%
                height="250" // MODIFIED: Changed from 300
                style={{ border:0 }}
      ...
      {/* Footer */}
      <footer className="bg-gray-900 text-gray-400 py-6 text-sm w-full"> {/* ADDED: w-full */}
        <div className="container mx-auto px-4 text-center">
